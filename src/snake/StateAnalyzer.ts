...
export class StateAnalyzer {
    ...
    static getSmallerHeadPoints(): IPoint[] {
        ...
        const smallerHeadPoints: IPoint[] = [];
    ...
    static getContestedNeighbors(): IPoint[] {
        const contestedNeighbors: IPoint[] = [];
